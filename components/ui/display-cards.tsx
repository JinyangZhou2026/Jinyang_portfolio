...
export default function DisplayCards({ cards }: DisplayCardsProps) {
  const defaultCards = [
    ...
    {
      className:
        "[grid-area:stack] translate-x-16 translate-y-10 grayscale-[100%] before:absolute before:left-0 before:top-0 before:h-[100%] before:w-[100%] before:rounded-xl before:bg-background/50 before:bg-blend-overlay before:outline before:outline-1 before:outline-border before:content-[''] before:transition-opacity before:duration-700 hover:-translate-y-1 hover:grayscale-0 hover:before:opacity-0",
    },
    {
  ...
  return (
    <div className="grid [grid-template-areas:'stack'] place-items-center opacity-100 duration-700 animate-in fade-in-0">
