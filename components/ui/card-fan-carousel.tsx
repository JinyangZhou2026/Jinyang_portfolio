...
const CARD_CLASSES =
  "fan-card absolute block aspect-[3/4] w-[8.5rem] overflow-hidden rounded-[1.25rem] border border-black/10 bg-black/5 shadow-[0_20px_60px_rgba(0,0,0,0.22)] sm:w-[10.5rem] md:w-[12.5rem] lg:w-[15rem] dark:border-white/10 dark:bg-white/5";
  ...
  return (
    <section className="relative z-20 flex w-full flex-col items-center px-4 py-4 md:px-8 lg:py-8">
      <div className="flex w-full max-w-[90rem] items-center justify-center">
        <div
          ref={containerRef}
          className="fan-layout relative flex h-[22rem] w-full max-w-[80rem] items-center justify-center sm:h-[26rem] md:h-[28rem] lg:h-[38rem]"
        >
            ...
            {cards.map((_, i) => (
              <span
                ...
                className={`h-2 w-2 rounded-full transition-all duration-300 ${
                  i === centerIndex ? "scale-[1.3] bg-black/70 dark:bg-white/80" : "bg-black/15 dark:bg-white/15"
                }`}
              />
            ))}
          </div>
