    ...
    <>
      ...
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-black to-slate-800 font-sans text-slate-100">
        ...
        <div className="relative z-10 flex min-h-screen flex-col items-center justify-between px-6 py-10 text-center sm:px-8 sm:py-12 md:px-16 md:py-20">
          <h2 className="text-xs font-light uppercase tracking-[0.2em] text-slate-300 opacity-80 sm:text-sm">
            <span className="word-animate" data-delay="0">Form</span>
          ...
          <div className="relative mx-auto max-w-5xl">
            <h1 className="text-decoration-animate text-3xl font-extralight leading-tight tracking-tight text-slate-50 sm:text-4xl md:text-5xl lg:text-6xl">
              <div className="mb-4 md:mb-6">
                <span className="word-animate" data-delay="700">Design</span>
                <span className="word-animate" data-delay="850">objects</span>
                <span className="word-animate" data-delay="1000">with</span>
                <span className="word-animate" data-delay="1150">clarity,</span>
              </div>
              <div className="text-xl font-thin leading-relaxed tracking-wide text-slate-300 sm:text-2xl md:text-3xl lg:text-4xl">
                <span className="word-animate" data-delay="1400">then</span>
                <span className="word-animate" data-delay="1550">turn</span>
                <span className="word-animate" data-delay="1700">them</span>
                <span className="word-animate" data-delay="1850">into</span>
                <span className="word-animate" data-delay="2000">images,</span>
                <span className="word-animate" data-delay="2150">motion,</span>
                <span className="word-animate" data-delay="2300">and</span>
                <span className="word-animate" data-delay="2450">stories.</span>
              </div>
            </h1>
          </div>
          ...
          <h2 className="text-xs font-light uppercase tracking-[0.2em] text-slate-300 opacity-80 sm:text-sm">
            ...
            <span className="word-animate" data-delay="3200">shape,</span>
            <span className="word-animate" data-delay="3400">visualize.</span>
          </h2>
        </div>
